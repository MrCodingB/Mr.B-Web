  ...
  return (
    <div className="introduction-section">
      <div className="container">
        ...
        <p>
          After deciding not to pursue studying IT as an adjunct student, I
          decided to take another job during the summer holidays at another
          software company called Signum Plus GmbH. I stayed at this company for
          quite a while longer than with the previous. But after deciding to
          skip the 4th year of technical college, therefore immediately jumping
          from 3rd to 5th year, I thought that with the graduation exams
